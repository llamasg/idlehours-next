...
export default function EndScreen({
  ...
  return (
    <div className="px-4 py-8">
      {/* ── Row 1: Box Art (left) + Steam Reviews (right) ── */}
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
        {/* Left column: Title + Box Art */}
        <div>
          <div className="mb-6 text-center lg:text-left">
            <p className="font-heading text-xs uppercase tracking-wider text-muted-foreground">
              Your Game Has Launched
            </p>
            <p className="mt-1 font-heading text-sm text-muted-foreground/70">
        ...
        {/* Right column: Steam review widget + breakdown */}
        <div>
          {/* Steam review widget */}
          <div>
            {/* Dark header */}
            ...
            {/* Body — includes score bar, verdict, and breakdown */}
            <div className="rounded-b-xl border border-t-0 border-border/60 bg-card p-5">
              ...
              {/* What the players said — inside the review widget */}
          ...
          <div className="mt-4 flex gap-3">
            <button
              type="button"
              onClick={handleShare}
              className="flex-1 rounded-full bg-primary px-6 py-3 font-heading text-sm font-semibold text-white transition-transform hover:scale-[1.02]"
            >
            ...
            <button
              type="button"
              onClick={onPlayAgain}
              className="flex-1 rounded-full border border-border/60 bg-card px-6 py-3 font-heading text-sm font-semibold text-foreground transition-transform hover:scale-[1.02]"
            >
              Play Again
            </button>
          </div>
      ...
      <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
        ...
        <div className="rounded-2xl bg-primary p-7">
          ...
          <p className="mt-3 font-heading text-sm leading-relaxed text-primary-foreground/80">
